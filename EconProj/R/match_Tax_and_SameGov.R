...
f1 <- as.formula(paste("m.data$`II.3: Centrally Sponsored Schemes` ~", paste0("m.data$`",names(m.data)[c(5,8)],"`",collapse = "+")))
f2 <- as.formula(paste("m.data$`II.2: Central Plan Schemes` ~", paste0("m.data$`",names(m.data)[c(5,8)],"`",collapse = "+")))
f3 <- as.formula(paste("m.data$`I.6: WMA from RBI` ~", paste0("m.data$`",names(m.data)[c(5,8)],"`",collapse = "+")))
f4 <- as.formula(paste("m.data$`II.D.5.c.1: GST compensation` ~", paste0("m.data$`",names(m.data)[c(5,8)],"`",collapse = "+")))
